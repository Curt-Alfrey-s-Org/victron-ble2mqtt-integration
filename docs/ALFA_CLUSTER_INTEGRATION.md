...
| Sungold inverter (optional USB sidecar) | `docs/SUNGOLD_SPH302480A.md` -- emergency dolly cart, not T2/KU |
...
| GX-style solar flow dashboard (local) | [SOLAR_FLOW_DASHBOARD.md](SOLAR_FLOW_DASHBOARD.md) -- victron clone + `scripts/solar_flow_server.py`; HA `.105:8123` via token file; dump-load explainer mirrors alfa-ai policy |
