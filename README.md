...
| [docs/SOLAR_HA_DASHBOARD.md](docs/SOLAR_HA_DASHBOARD.md) | Canonical live watts: HA built-in **Energy** on `.105:8123/energy` |
| [docs/SOLAR_FLOW_DASHBOARD.md](docs/SOLAR_FLOW_DASHBOARD.md) | Retired SVG `:8765` stub |
